<template>
  <div class="header">
    <div class="content-wrapper">
      ...
      <div v-if="seller.supports" class="supports-count" @click="showDatail">
    ...
    <div class="bulletin-wrapper">
      ...
      <span class="bulletin-text" @click="showDatail">{{seller.bulletin}}</span>
